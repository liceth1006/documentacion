        ...
        <div className="flex flex-row 3xl:flex-1 ">
          ...
          <div className="f">
            <div className="flex items-center justify-center h-full pt-1">
              <Link
                className="active:scale-95 overflow-hidden transition-transform relative items-center  p-1 whitespace-nowrap  rounded-full  inline-flex text-lg font-normal gap- "
                href="/"
              >
                <Image
                  src={Logo}
        ...
        <div className="items-center justify-center flex-1 hidden w-full md:flex 3xl:w-auto 3xl:shrink-0 3xl:justify-center">
          ...
          >
            ...
            <span className="hidden ms-auto sm:flex item-center me-1">
              <kbd className="w-10 h-5 border border-transparent me-1 bg-wash dark:bg-wash-dark text-gray-30 align-middle p-0 inline-flex justify-center items-center text-xs text-center rounded-md ">
                Ctrl
              </kbd>
              <kbd className="w-10 h-5 border border-transparent me-1 bg-wash dark:bg-wash-dark text-gray-30 align-middle p-0 inline-flex justify-center items-center text-xs text-center rounded-md ">
                k
