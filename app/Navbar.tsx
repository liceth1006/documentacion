...
export default function Navbar() {
  ...
  const handleItemClick = () => {
    const selectTheme =document.documentElement.getAttribute("data-theme");
    const nextTheme = selectTheme  === "dark" ? "light" : "dark";
    ...
    <div className="flex items-center justify-between w-full h-16 gap-0 sm:gap-3">
      <div className="flex flex-row 3xl:flex-1 ">
        ...
        <div className="flex flex-column justify-center items-center">
          <a
            className=" flex py-2 flex-column justify-center items-center
                   text-gray-50 dark:text-gray-30 hover:text-link hover:dark:text-link-dark hover:underline
                    text-sm ms-1 cursor-pointer"
            href="/versions"
          ></a>
        </div>
      </div>
      <div className="items-center justify-center flex-1 hidden w-full md:flex 3xl:w-auto 3xl:shrink-0 3xl:justify-center">
        <button
          type="button"
          className="flex 3xl:w-[56rem] 3xl:mx-0 relative ps-4 pe-1 py-1 h-10 bg-gray-30/20 dark:bg-gray-40/20 outline-none focus:outline-link betterhover:hover:bg-opacity-80 pointer items-center text-start w-full text-gray-30 rounded-full align-middle text-base bg-gray-100"
        >
          <svg
            width="1em"
            height="1em"
          ...
          <span className="hidden ms-auto sm:flex item-center me-1" >
            <kbd className="w-10 h-5 border border-transparent me-1 bg-wash dark:bg-wash-dark text-gray-30 align-middle p-0 inline-flex justify-center items-center text-xs text-center rounded-md " >Ctrl</kbd>
            <kbd className="w-10 h-5 border border-transparent me-1 bg-wash dark:bg-wash-dark text-gray-30 align-middle p-0 inline-flex justify-center items-center text-xs text-center rounded-md " >k</kbd>
          </span>
        </button>
      </div>
