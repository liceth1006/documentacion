        ...
        <aside className="lg:grow flex-col w-full pb-8 lg:pb-0 lg:max-w-custom-xs z-10 hidden lg:block">
          <nav className="w-full pt-6 scrolling-touch lg:h-auto grow pe-0 lg:pe-5 lg:pb-16 md:pt-4 lg:pt-4 scrolling-gpu">
            ...
            <li className="pb-2 mb-3">
                <Link href="/Overview" className={ `p-2 pe-2 w-full rounded-none lg:rounded-e-2xl text-start hover:bg-gray-200 dark:hover:bg-gray-80 relative flex items-center justify-between ps-5  bg-highlight link ${pathname === '/Overview' ? 'bg-sky-200' : ''}`}>
                  <div>Descripción general</div>
                  
                </Link>
              </li>
              <li className="pb-2 mb-3">
                <Link href="/Poo" className={ `p-2 pe-2 w-full rounded-none lg:rounded-e-2xl text-start hover:bg-gray-200 dark:hover:bg-gray-80 relative flex items-center justify-between ps-5  bg-highlight link ${pathname === '/Poo' ? 'bg-sky-200' : ''}`}>
                  <div>Descripción general</div>
