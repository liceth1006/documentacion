              ...
              <div>
                <div className="px-5 sm:px-12 ">
                  ...
                  <p className="whitespace-pre-wrap my-4">
                    ...
                    que se centra en el concepto de &quot;objetos&quot;. Ahora,
                    no me refiero a objetos físicos como una silla o una mesa,
                    sino a entidades virtuales que tienen propiedades (también
                    llamadas atributos) y comportamientos (también llamados
                    métodos). Estos objetos interactúan entre sí, lo que permite
                    construir programas complejos y modulares de una manera más
